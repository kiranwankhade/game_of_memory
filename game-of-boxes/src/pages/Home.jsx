    ...
    <div className="home-page-container " data-theme={theme || "light"}>
      <div className="home-card">
        <div className="hero-section">
          ...
          <h1 className="main-title text-center w-full text-nowrap">
            Game <span className="title-accent">of</span> Boxes
          </h1>
          <p
            className="subtitle-text"
            style={{ color: "var(--text)", opacity: 0.8 }}
          >
            A minimalist memory challenge. Match the patterns, beat the clock,
        ...
        <div className="visual-section">
          <div className="responsive-grid">
            {gridCells.map((_, i) => (
              <div
                key={i}
                className={`grid-cell ${
                  activeIndices.includes(i) ? "cell-active" : "cell-idle"
                }`}
              />
            ))}
          </div>
          ...
          <p
            ...
            style={{ color: "var(--text)", opacity: 0.5, fontSize: "0.8rem" }}
          >
